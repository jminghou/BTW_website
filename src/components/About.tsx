...
const About = () => {
    ...
    return (
      <div className="container mx-auto px-6">
        ...
        {/* 创建弹性布局容器 */}
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto gap-8 items-center mb-16">
          {/* 左侧图片 */}
          ...
          <div className="w-full md:w-[45%] md:pl-6">
            ...
            <p className="text-sm leading-7 text-gray-600 pt-4">
        ...
        <div className="max-w-6xl mx-auto mb-16">
          ...
          {/* Logo跑馬燈容器 */}
          <div className="relative overflow-hidden w-full h-24 bg-white">
            {/* 使用兩組相同的logo實現無縫滾動 */}
        ...
        <div className="flex justify-center mb-8">
          <div 
            className="text-gray-600 text-6xl cursor-pointer hover:text-gray-300 transition-colors duration-300 font-bold animate-bounce"
