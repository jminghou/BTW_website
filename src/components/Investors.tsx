        ...
        <div className="flex flex-col md:flex-row max-w-6xl mx-auto gap-8 items-center">
          ...
          <div className="w-full md:w-[45%] md:pl-6">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-lg text-gray-700 leading-loose">浩華智能取餐正引領企業用餐革命！我們以AIoT智能取餐機與All for One配送系統，解決傳統團膳效率低、選擇少的痛點，瞄準千億級企業用餐市場。創新商業模式已獲百家名店與指標企業採用，年營收成長突破50%。立即下載募資簡報，掌握智能餐飲的未來商機！</p>
              </div>
